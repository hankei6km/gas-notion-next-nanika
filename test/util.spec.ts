...
describe('titleParams', () => {
  ...
  it('should handle @startTime correctly', () => {
    const result = titleParams('Event @startTime', '2023-10-01T10:00:00Z', null)
    expect(result).toEqual([
      { text: { content: 'Event ' } },
      {
        mention: {
  ...
  it('should handle @startDate correctly', () => {
    const result = titleParams('Event @startDate', '2023-10-01T10:00:00Z', null)
    expect(result).toEqual([
      { text: { content: 'Event ' } },
      {
        mention: {
  ...
  it('should handle text without timestamps correctly', () => {
    ...
    expect(result).toEqual([{ text: { content: 'Event without timestamps' } }])
  })
